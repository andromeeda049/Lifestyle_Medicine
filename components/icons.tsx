...
export const SquaresIcon = ({ className }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M4 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2V6zM14 6a2 2 0 012-2h2a2 2 0 01-2 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2V6zM4 16a2 2 0 012-2h2a2 2 0 01-2 2H6a2 2 0 01-2-2v-2zM14 16a2 2 0 012-2h2a2 2 0 01-2 2h-2a2 2 0 01-2-2v-2z" />
    </svg>
);
...
export const WaterDropIcon = ({ className }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M12 2.25c-5.385 5.965-8.25 8.341-8.25 11.5C3.75 18.305 7.444 22.25 12 22.25s8.25-3.945 8.25-8.5c0-3.159-2.865-5.535-8.25-11.5z" />
  </svg>
);
...
export const TrophyIcon = ({ className }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M16.5 18.75h-9m9 0a3 3 0 013 3h-15a3 3 0 013-3m9 0v-3.375c0-.621-.503-1.125-1.125-1.125h-.871M7.5 18.75v-3.375c0-.621.504-1.125 1.125-1.125h.872m5.007 0H9.497m5.007 0V5.25m-5.007 0V15.375m-5.007 0V5.25a2.25 2.25 0 012.25-2.25h5.007a2.25 2.25 0 012.25 2.25v10.125" />
    </svg>
);
...
export const MedalIcon = ({ className }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 3.75v16.5M6 11.25a6 6 0 1112 0m-6-6a6 6 0 016 6" />
...
export const LineIcon = ({ className }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className={className} fill="#06C755">
        <path d="M21.4 10.6C21.4 6.4 17.1 3 11.9 3S2.4 6.4 2.4 10.6c0 3.8 3.3 6.9 7.8 7.5.3.1.7.2.8.5 0 0 .2 1 .4 1.9.1.6.1 1-.5 1.6-.9.8-4.6-2.7-6.3-4.1C3.2 16.9 2.4 14.8 2.4 12c0-4.9 4.5-8.8 10.1-8.8 5.6 0 10.1 3.9 10.1 8.8 0 4.9-4.5 8.8-10.1 8.8-1.3 0-2.5-.2-3.6-.6-.6-.2-1.3-.1-1.7.4-.3.3-.2.8.3 1 1.5.5 3.1.8 4.8.8 6.5 0 11.7-4.6 11.7-10.2zM7.6 12.7c0 .3-.3.5-.6.5H5.7c-.3 0-.5-.2-.5-.5V8.5c0-.3.2-.5.5-.5s.5.2.5.5v3.1h1.4c.3 0 .6.2.6.5zm2.7 0c0 .3-.2.5-.5.5s-.5-.2-.5-.5V8.5c0-.3.2-.5.5-.5s.5.2.5.5v4.2zm4.3 0c0 .3-.2.5-.5.5s-.5-.2-.5-.5V9.9l-1.8 2.4c-.1.2-.3.3-.5.2-.2 0-.4-.1-.4-.3V8.5c0-.3.2-.5.5-.5s.5.2.5.5v2.3l1.8-2.4c.1-.1.2-.2.4-.2.2 0 .4.1.4.3v4.2zm4.2 0c0 .3-.2.5-.5.5H17c-.3 0-.5-.2-.5-.5V8.5c0-.3.2-.5.5-.5h1.4c.3 0 .5.2.5.5s-.2.5-.5.5h-.8v.9h.8c.3 0 .5.2.5.5s-.2.5-.5.5h-.8v.9h.8c.3 0 .5.2.5.5z"/>
    </svg>
);
